...
public final class FishingChallengeManager {
     ...
     * =========================================================
     *
     * Ultra Rare round 2 also uses this pool.
     */
    ...
    public static void startCurrentRound(
        ...
        /*
         * Prevent the same movement behavior
    ...
    private static FishingChallengePreset selectPreset(
        ...
        /*
         * Common / Uncommon remain the normal
         * one-round fishing system.
         */
    ...
    private static FishingChallengePreset selectNormalPreset(
        ...
        return switch (normalized) {
             ...
             * Safety fallback.
             *
             * Rare should normally now be classified
             * as FishingChallengeType.RARE.
             */
            case "rare" ->
                    new FishingChallengePreset(
                            "rare_fallback",
    ...
    private static List<FishingChallengePreset> getChallengePool(
        ...
        return switch (
            ...
            /*
             * NORMAL never actually reaches this.
             */
            case NORMAL ->
                    BOSS_EARLY;
        };
    ...
    /*
     * =========================================================
     * AVOID CONSECUTIVE MOVEMENT DUPLICATES
     * =========================================================
     */
    private static FishingChallengePreset pickWithoutRepeatingBehavior(
        ...
        for (FishingChallengePreset preset
                : pool) {
        ...
        /*
         * Fallback if every preset somehow uses
         * the same movement.
         */
